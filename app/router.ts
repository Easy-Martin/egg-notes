...
export default (app: Application) => {
    ...
    router.get('/organization/queryOrganizations', controller.organization.queryOrganizations)
    router.get('/organization/queryOrganization', controller.organization.queryOrganization)
